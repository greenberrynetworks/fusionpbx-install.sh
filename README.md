...
```sh
wget -O - https://raw.githubusercontent.com/greenberrynetworks/fusionpbx-install.sh/master/debian/pre-install.sh | sh;
cd /usr/src/fusionpbx-install.sh/debian && ./install.sh
```

### Ubuntu and Raspberry OS
```sh
wget -O - https://raw.githubusercontent.com/greenberrynetworks/fusionpbx-install.sh/master/ubuntu/pre-install.sh | sh;
...
```sh
wget -O - https://raw.githubusercontent.com/greenberrynetworks/fusionpbx-install.sh/master/devuan/pre-install.sh | sh;
...
```sh
pkg install --yes git
cd /usr/src && git clone https://github.com/greenberrynetworks/fusionpbx-install.sh.git
...
```sh
wget -O - https://raw.githubusercontent.com/greenberrynetworks/fusionpbx-install.sh/master/centos/pre-install.sh | sh
...
Master https://github.com/greenberrynetworks/fusionpbx-install.sh/archive/master.zip
```
